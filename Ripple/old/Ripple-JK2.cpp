...
double g=9.8, Rol=9.4e-3, Rpipe=12.7e-3, Aol, Lol=200e-3, Lpipe=3000e-3, Apipe;
int PCYCLE=0, Nol=200, Np=12000;
...
void Input()
{
	...
	if((ep = fopen("Input_pressure_48.dat", "r"))==NULL) {
		printf("Cannot open file.\n");
		exit(1);
	}
...
void Derivs(double phid, double *Pt, double *dP, double *Pol, double *Qol)
{
	...
	double Cv, *Pr, Pv, *phiD, *Lpc, Ao1, Ao2, Qvo, Qvi,Apo, Lvp=100e-3, Ain, Aout, bv1, bv2, bvo=20e-3, Lv1=500e-3, Rpipei=20e-3, Lv2=500e-3, Lv3=300e-3, Lv4=500e-3, tanv, Bv, Cvpo;
	...
	//dP[N+3] = Aout/Lv3/w/rho*((Pt[N+1]-Pout*0.89) - 200/pow(Aout/*11.8e-6*/,2)*rho/2*Pt[N+3]*fabs(Pt[N+3]));
