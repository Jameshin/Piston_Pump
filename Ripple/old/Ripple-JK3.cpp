...
double g=9.8, Rol=9.4e-3, Rpipe=12.7e-3, Aol, Lol=300e-3, Lpipe=10e-3, Apipe;
int PCYCLE=0, Nol=1200, Np=30;
...
void Derivs(double phid, double *Pt, double *dP, double *Pol, double *Qol)
{
	...
	double Cv, *Pr, Pv, *phiD, *Lpc, Ao1, Ao2, Qvo, Qvi,Apo, Lvp=100e-3, Ain, Aout, bv1, bv2, bvo=20e-3, Lv1=500e-3, Rpipei=20e-3, Lv2=500e-3, Lv3=1500e-3, Lv4=500e-3, tanv, Bv, Cvpo;
	...
	//dP[N+3] = Aout/Lv3/w/rho*((Pt[N+1]-Pout*0.9) - 3/pow(Aout*0.05/*11.8e-6*/,2)*rho/2*Pt[N+3]*fabs(Pt[N+3]));
