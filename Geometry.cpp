...
extern int Nphi, NBz1, NBz2, NBz3, NBz4, NBz5, NBz, NNBz, NNBt, Nch;
extern double R, Rp, Lc, Ld, rB, rV1, rV2, LB1, LB2, Cv, Cs, Pin, Pout, Ph, rho, eta, K, Rs1, Rs2, Rso, beta, beta2, phif, phiout_c, phiout_vb, phiout_FM, phiout_LK, w;
